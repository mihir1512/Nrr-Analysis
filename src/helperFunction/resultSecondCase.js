...
exports.solveResultForSecondCase=(param)=>{
    ...
    const obj1={a,b,c,d,e,f,g,h,i,j,k,tossResult,oppositionTeam,targetPositionTeam,check:false}
    ...
    const obj2={a,b,c,d,e,f:sortedData[position-2].nrr,g,h,i,j,k,tossResult,oppositionTeam,targetPositionTeam,check:true}
    

    if(tossResult==='bowling')
            {              
                let y=solveInequality(obj1)-(0.1)
                if(y>k)
                {
                    y=k
                }
                ...
                console.log(/lowerNrr/,lowerNrr,/higherNrr/,higherNrr,/x/,x);
